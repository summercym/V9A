    ...
    <nav class="navbar-default navbar-static-side" role="navigation">
        <div class="sidebar-collapse">
            <ul class="nav" id="side-menu">
                <li class="nav-header">
                    <div class="dropdown profile-element"> <span>
                        ...
                        <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                                <span class="clear"> <span class="block m-t-xs"> <strong class="font-bold"><?php echo @$_SESSION['uname']?></strong>
                ...
                <li class="active">
                    <a href=""><i class="fa fa-edit"></i> <span class="nav-label">功能</span> <span class="label label-danger pull-right">2.0</span></a>
