	...
	<body style="background-color: rgba(54, 21, 55, 0.93)">
			...
			<div class="row well" style="margin:auto 0;">
				<div class="col-xs-3">
					...
					<div class="panel panel-default">
						...
						<ul class="list-group">
							<a href="javascript:;" class="list-group-item list-group-item-info">&nbsp; 许可协议</a>
							<a href="javascript:;" class="list-group-item"> &nbsp; 环境监测</a>
							<a href="javascript:;" class="list-group-item"> &nbsp; 参数配置</a>
		...
		<form class="form-inline" role="form" action="index.php?r=common/one" method="post">
			<ul class="pager">
                ...
                <li class="previous"><a href="javascript:;" onclick="$(&#39;#do&#39;).val(&#39;&#39;);$(&#39;form&#39;)[0].submit();">继续 </a></li>
