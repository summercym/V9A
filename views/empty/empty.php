...
<head>
    ...
    <link href="./V9A/font-awesome/css/font-awesome.css?v=4.3.0" rel="stylesheet">

    <link href="./V9A/css/animate.css" rel="stylesheet">
...
<a href="index.php?r=login/login" class="btn btn-primary m-t">打开主页</a>
