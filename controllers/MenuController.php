...
class MenuController extends Controller{
	...
	public function actionAddll(){
		...
		$post=$command = $connection->createCommand()->update("numbers",['we_status'=>1],['number_id'=>$number_id])->execute();
    ...
    function uploadImage(){
        ...
        $url="https://mp.weixin.qq.com/debug/cgi-bin/media/?t=index&type=";
    }
}