...
Class MessageController extends Controller{
   public $layout='common.php';
    ...
    public function actionContent(){
        ...
        if($uname =="" || $uname==false){
            ...
            if(empty($re)){
                ...
                $message_title=htmlspecialchars($request->post("message_title"));
                $message_this=htmlspecialchars($request->post("message_this"));
                $message_content=htmlspecialchars($request->post("message_content"));
    ...
    public function actionUpdate(){
        ...
        $connection = \Yii::$app->db;
        $id=$request->post("id");
        $message_title=htmlspecialchars($request->post('message_title'));//公众号名称
        $message_this=htmlspecialchars($request->post('message_this'));//公众号类型
        $message_content=htmlspecialchars($request->post('message_content'));//公众号appid
